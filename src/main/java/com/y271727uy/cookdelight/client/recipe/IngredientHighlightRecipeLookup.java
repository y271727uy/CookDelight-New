...
public final class IngredientHighlightRecipeLookup {
    ...
    public Optional<ResolvedRecipe> findRecipe(Level level, ItemStack output) {
        ...
        List<String> patterns = RecipeLookupSupport.normalizePatterns(CookDelightConfig.ingredientHighlightRecipeTypes());
